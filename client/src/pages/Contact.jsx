      ...
      <div className={`${isMobile ? 'mobile-form-container' : ''} bg-white dark:bg-gray-800 rounded-2xl shadow-sm border dark:border-gray-700 overflow-hidden`}>
        <form onSubmit={submit} className="grid gap-4 sm:gap-5 p-4 sm:p-6">
          <div className="space-y-1">
            ...
            <input
              className="w-full border rounded-lg px-3 py-3 sm:py-2 text-base outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition dark:bg-gray-700 dark:border-gray-600 dark:text-white"
          ...
          <div className="space-y-1">
            ...
            <textarea
              className="w-full border rounded-lg px-3 py-3 sm:py-2 min-h-[120px] sm:min-h-[150px] text-base outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition dark:bg-gray-700 dark:border-gray-600 dark:text-white"
